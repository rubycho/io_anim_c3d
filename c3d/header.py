...
class Header(object):
    ...
    def __init__(self, handle=None):
        ...
        self.event_disp_flags = np.zeros(0, dtype=np.bool_)
        self.event_labels = []
    ...
    def _parse_events(self, dtypes, float_unpack):
        ...
        self.event_disp_flags = np.zeros(read_count, dtype=np.bool_)
    ...
    def encode_events(self, events):
        ...
        self.event_disp_flags = np.ones(write_count, dtype=np.bool_)
